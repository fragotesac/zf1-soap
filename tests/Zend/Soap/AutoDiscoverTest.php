...
class Zend_Soap_AutoDiscoverTest extends PHPUnit\Framework\TestCase
{
    ...
    {
        $server = new Zend_Soap_AutoDiscover();
        $this->expectException(Zend_Soap_AutoDiscover_Exception::class);
    ...
    public function testUnusedFunctionsOfAutoDiscoverThrowException()
    {
        ...
        try {
            ...
            $this->assertSame('Function has no use in AutoDiscover.', $e->getMessage());
        }
    ...
    public function testDumpOrXmlOnlyAfterGeneratedAutoDiscoverWsdl()
    {
        ...
        try {
            ...
            $this->assertInstanceOf(Zend_Soap_AutoDiscover_Exception::class, $e);
        }
